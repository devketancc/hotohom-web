  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="font-heading text-lg font-semibold tracking-tight text-foreground sm:text-xl">Add-ons</h2>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
            Manage optional extras for bookings — pricing per day or per booking, and caravan class availability.
          </p>
        </div>
